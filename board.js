...
>>>>>>> 48564793d032b5461624813673e904f4c0213b8e
...
function openFullscreen(id) {
  ...
  fullscreen.innerHTML = `
    <div class="fullscreenTask">
      <div class="fullscreenTaskHeadline">
        <h2 class="fontColor">${task['title']}</h2>
        <span style="margin-left: 8px;">Urgency</span>
      </div><br>
      <div style="display: flex; flex-direction: column;">
        <div>
          <span style="display: flex; align-items: center;">Assigned to: ${task['selectetAvatar']['name']}, ${task['selectetAvatar']['email']} <img class="taskPicture" src="${task['selectetAvatar']['picture']}"></span><br>
        </div>  
